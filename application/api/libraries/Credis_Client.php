...
class Credis_Client {
     ...
     */
    public function __construct($timeout = null, $persistent = '', $db = 0, $password = null)
    {
    	$this->ci =& get_instance();
    	
        $this->host = (string) $this->ci->config->item('redis_host');
        $this->port = (int) $this->ci->config->item('redis_port');
